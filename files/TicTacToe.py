...
class Counter:
    '''Represente a Counter used on the board'''
    ...
    def getLabel(self)->str:
        return self.__label
    def setLabel(self, lb)->None:
        self.__label = lb
    

class Move:
    '''Represente a move made by a player'''
    def __init__(self,counter, x, y) -> None:
...
class Player(metaclass=ABCMeta):
    ...
    def counter(self)->int:
        '''Representes Player Counter - may be X or Y'''
        return self.__counter
    ...
    def __str__(self) -> str:
        return f'{self.__class__.__name__} [{str(self.counter)}]'
...
class HumanPlayer(Player):
    ...
    def get_move(self):
        '''Alow teh human player to enter their move '''
        while True:
...
class ComputerPlayer(Player):
    ''' Implemets algorithms for playing game '''
    def __init__(self, board) -> None:
        super().__init__(board)
    ...
    def get_move(self):
        ...
        elif self.board.is_empty_cell(0,1):
            return Move(self.counter, 0,1)
        
        elif self.board.is_empty_cell(1,0):
            return Move(self.counter, 1,0)
        
        elif self.board.is_empty_cell(1,2):
            return Move(self.counter, 1,2)
        
        elif self.board.is_empty_cell(2,1):
            return Move(self.counter, 2,1)
...
class Game:
    ...
    def select_player_counter(self):
        ''' Left the player select their counter '''
        counter = ''
    ...
    def play(self):
        ...
        while self.winner is None:
            ...
            if self.winner is not None:
                print(f'The Winner is the {str(self.winner)} \n')
